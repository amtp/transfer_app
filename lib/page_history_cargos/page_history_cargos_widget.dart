...
class PageHistoryCargosWidget extends StatefulWidget {
  const PageHistoryCargosWidget({Key key}) : super(key: key);

  @override
  _PageHistoryCargosWidgetState createState() => _PageHistoryCargosWidgetState();
}

class _PageHistoryCargosWidgetState extends State<PageHistoryCargosWidget>
