...
class AmLoadingOptions {
  const AmLoadingOptions({
    this.textStyle,
    this.elevation,
    this.height,
    this.width,
...
class AmLoadingWidget extends StatefulWidget {
  const AmLoadingWidget({
    Key key,
    @required this.text,
  ...
  final AmLoadingOptions options;
  final bool showLoadingIndicator;

  @override
  State<AmLoadingWidget> createState() => _AmLoadingWidgetState();
}

class _AmLoadingWidgetState extends State<AmLoadingWidget> {
  bool loading = false;
